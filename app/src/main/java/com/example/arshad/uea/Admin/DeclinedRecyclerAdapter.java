...
public class DeclinedRecyclerAdapter extends RecyclerView.Adapter<DeclinedRecyclerAdapter.ViewHolder> {
    ...
    public DeclinedRecyclerAdapter(List<EventPost> event_list){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.declined_list_item, parent, false);
